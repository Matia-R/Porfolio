let projectItems = [
    ...
    },
    {
        ...
        description: "Sociallect is a Software Startup I co-founded in 2020 with some close colleagues from university. Our main objective is to develop tools services that help small businesses create more effective Social Media marketing using Machine Learning. Since we started, I’ve contributed by developing our company website as well as researching options for web infrastructure and hosting. In doing so, I’ve educated myself on cloud technologies and obtained an AWS cloud practitioner certificate. We are still in very early stages and do not have a public presence yet, but if you’re interested in the project, please leave me a message and I’d be happy to discuss.",
        tags: [
            "JavaScript",
            "Webflow",
            "HTML5",
